...
MEM_0 := NiosPheriSys_onchip_memory
...
$(MEM_1)_HIERARCHICAL_PATH := sdram_cntr
$(MEM_1)_WIDTH := 16
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: sdram_cntr
sdram_cntr: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
